...
public class StepActions {
		...
		public void enter_demographics_informations() {
		    driver.findElement(By.xpath("//input[@name='givenName']")).sendKeys("Anila");
		    driver.findElement(By.xpath("//input[@name='familyName']")).sendKeys("Edayadil");
		    ...
		    driver.findElement(By.xpath("//button[@id='next-button']")).click();
		    driver.findElement(By.xpath("//input[@id='birthdateDay-field']")).sendKeys("02");
		...
		public void enter_contactinfo() {
			 driver.findElement(By.xpath("//input[@id=\"address1\"]")).sendKeys("Nedumkunnam");
			 driver.findElement(By.xpath("//button[@id='next-button']")).click();
			 driver.findElement(By.xpath("//button[@id='next-button']")).click();
		}
		...
		public void enter_search_by_name() {
		    driver.findElement(By.xpath("//input[@placeholder='Search by ID or Name']")).sendKeys("Anila");
		}
		...
		public void update_patient_name_and_save() {
		    ...
		    driver.findElement(By.xpath("//input[@name='givenName']")).sendKeys("AnilaXavier");
		...
		public void clicks_on_confirm_and_patient_name_should_update_successfully() {
			...
			wdw.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@class='PersonName-givenName']")));
					...
					Assert.assertEquals(actual_updated_name.getText(), "AnilaXavier");
		}
